...
;                                                          ;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
::isympda::cd /usr/local/waters/isym/utils/scripts/ && sudo ./config-isym-emu-pda.sh && sudo ./start-isym-emu.sh
::isymtuv::cd /usr/local/waters/isym/utils/scripts/ && sudo ./config-isym-emu-tuv.sh && sudo ./start-isym-emu.sh
...
setTransVal(direction)
{
  ...
  ToolTip, %title%`nTransparency: %winTransVal%
